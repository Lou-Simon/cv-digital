   ...
   <div id="banner">
     <main>
      <Container className="py-5">
        <h1 className="mb-5 text-center">Mes formations</h1>
        <Row className="gy-4">
          <Col md={6}>
            <ListGroup.Item className="border-0 p-4 shadow-sm rounded-3 bg-light item">
              ...
              <p>Cursus sportif de haut niveau</p>
              <p><strong>Baccalauréat général</strong> avec mention assez bien (spécialités Mathématiques/Physique-Chimie).</p>
            </ListGroup.Item>
          </Col>
          <Col md={6}>
            <ListGroup.Item className="border-0 p-4 shadow-sm rounded-3 bg-light item">
              <h3 className="mb-3">
                <FontAwesomeIcon icon={faGraduationCap} className="me-2 text-primary" />
                <strong>UBO | Licence informatique, Brest</strong>
              </h3>
              <div className="text-muted mb-2">
                <FontAwesomeIcon icon={faCalendarAlt} className="me-2" />
